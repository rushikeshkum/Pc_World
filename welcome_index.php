...
<body>
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				...
				<div class="carousel-caption">
					...
					<p class="animated fadeInUp" style="animation-delay: 3s"><a href="login.php">Visit </a></p>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 categoryH-box aos-init aos-animate" data-aos="fade-up">
						<div class="categoryH-boxInn">
							...
							<a href="login.php" class="btn-comm">
								View More
	...
	<section class="why-choose-sec" id="about">
		<div class="container-fluid container-fluid-cust">
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-7 col-md-7 col-sm-12 motto-content">
					...
					<p>
						...
						at: <a href="rushikeshkumbhar151@gmail.com">rushikeshkumbhar151@gmail.com</a> or making a phone call on: <a
					...
					<a href="contactus_index.php" class="btn-comm mt-3 aos-init aos-animate" data-aos="fade-up">Contact Us <i
